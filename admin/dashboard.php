            ...
            <div class="row text-white">
                <div class="card bg-info ml-5" style="width: 18rem;">
                    <div class="card-body">
                      ...
                      <a href="dashboard_movies.php"><p class="card-text text-white">detail <i class="fas fa-angle-double-right ml-2"></i></p></a>
                    </div>
                  </div>
                <div class="card bg-success ml-5" style="width: 18rem;">
                    <div class="card-body">
                      ...
                      <div class="display-4"></div>
                      <a href="users.php"><p class="card-text text-white">detail <i class="fas fa-angle-double-right ml-2"></i></p></a>
                    </div>
                  </div>
            ...
            <div class="row mt-4">
                <div class="card ml-5 text-white text-center"style="width: 18rem;">
                    ...
                    <div class="card-body">
                      ...
                      <a href="https://www.instagram.com/rzaalifpsh?igsh=c296a2l1ZzNmaXZ5" class="btn btn-danger">FOLLOW</a>
                    </div>
                  </div>
                <div class="card ml-5 text-white text-center"style="width: 18rem;">
                    ...
                    <div class="card-body">
                      <h5 class="card-title text-info">TIK TOK</h5>
                      <a href="https://www.tiktok.com/@rizaalif46?_t=8mpNSzymyvp&_r=1" class="btn btn-info">FOLLOW</a>
                    </div>
                  </div>
            </div>
        </div>
